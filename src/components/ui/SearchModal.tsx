...
import { MenuItem, Sale, Expense } from "@/lib/types";
            ...
            <>
              {results.menu.length > 0 && (
                <div>
                  ...
                  <div className="space-y-1">
                    {results.menu.map(m => (
                      <div key={m.id} className={`p-3 rounded-xl flex justify-between items-center transition ${darkMode ? "hover:bg-white/5" : "hover:bg-slate-50"}`}>
              ...
              {results.sales.length > 0 && (
                <div>
                  ...
                  <div className="space-y-1">
                    {results.sales.map(s => (
                      <div key={s.id} className={`p-3 rounded-xl flex justify-between items-center transition ${darkMode ? "hover:bg-white/5" : "hover:bg-slate-50"}`}>
                        <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    {results.expenses.map(e => (
                      <div key={e.id} className={`p-3 rounded-xl flex justify-between items-center transition ${darkMode ? "hover:bg-white/5" : "hover:bg-slate-50"}`}>
                        <div className="flex items-center gap-3">
