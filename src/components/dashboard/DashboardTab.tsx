  ...
  return (
    <section className="grid items-start gap-4 xl:grid-cols-[2fr_1fr]">
      ...
      <div className="h-[250px] rounded-3xl border border-violet-100 bg-gradient-to-br from-white via-violet-50/30 to-white p-3.5 shadow-sm">
        ...
        <p className="mt-1 text-[11px] text-slate-500">Çeyreklik satış performansı analizi</p>
        <div className="mx-auto mt-3 h-36 w-36 rounded-full bg-[conic-gradient(#6d28d9_var(--value),#e9d5ff_0)] [--value:70%] p-3" style={{ ["--value" as string]: `${gaugePercent}%` }}>
          <div className="flex h-full w-full items-center justify-center rounded-full bg-white">
            <div className="text-center">
              <p className="text-xl font-semibold text-slate-900">{tl.format(Math.max(stats.net, 0))}</p>
              <p className="text-[11px] text-slate-400">Özet</p>
            </div>
          </div>
        </div>
        <div className="mt-2.5 grid grid-cols-2 gap-2 border-t border-slate-100 pt-2.5 text-sm">
          <div>
            <p className="text-xs text-slate-400">Aylık</p>
            <p className="text-base font-semibold text-slate-900">{tl.format(stats.totalSales * 0.32)}</p>
          </div>
          <div>
            <p className="text-xs text-slate-400">Yıllık</p>
            <p className="text-base font-semibold text-slate-900">{tl.format(stats.totalSales * 0.96)}</p>
          </div>
        </div>
      </div>
      <div className="rounded-3xl border border-indigo-100 bg-gradient-to-br from-white via-indigo-50/30 to-white p-3.5 shadow-sm xl:col-span-1">
        <p className="text-base font-semibold text-slate-900">Satış Analitiği</p>
        <p className="text-[11px] text-slate-500">Ciro analiz raporu içgörüleri</p>
      ...
      <div className="rounded-3xl border border-emerald-100 bg-gradient-to-br from-white via-emerald-50/30 to-white p-3.5 shadow-sm xl:col-start-2">
        <p className="text-base font-semibold text-slate-900">En Çok Satan Ürünler</p>
        <p className="text-[11px] text-slate-500">En çok satılan ürün analizi</p>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-3.5 shadow-sm xl:col-span-1">
        <p className="text-base font-semibold text-slate-900">Son İşlemler</p>
        <p className="text-[11px] text-slate-500">Son işlemlerin özet görünümü</p>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-3.5 shadow-sm xl:col-start-2">
